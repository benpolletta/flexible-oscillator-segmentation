...
spec.populations(i).parameters = {...
    ...
    'I_const', 0, 'ton', 500, 'toff', Inf, 'I_app', -9.2, 'Inoise', 0.25,...                                         %  (ton<t&t<toff) %%% 'PPstim = 0; PPfreq = 1.5; PPwidth = floor((1000/PPfreq)/4); PPshift = 0; ap_pulse_num = 0; kernel_type = 7;',... % in ms
    'PPonset', 10, 'gCar', 0, 'gSpeech', 0, 'VPstim', 0,... % 'STPstim',0, 'dsfact',dsfact,...
    };
% spec.populations(i).parameters = {...
